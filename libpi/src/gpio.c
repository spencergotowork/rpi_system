...
// {
//     // unsigned reg_num = pin / 10;
//     volatile unsigned *address = gpio_gpfsel0 ;//+ (reg_num * sizeof(unsigned));
//     unsigned current = get32(address);
//     unsigned shift = pin % 10;
//     switch (function)
//     {
...
//     default:
//         current &= ~(0b111 << (shift * 3));
//         current |= ((0b111 & function) << (3 * shift));
...
void gpio_set_function(unsigned pin, gpio_func_t fv) {
